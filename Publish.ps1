...
param (
    ...
    ## => User Config <= ## 
    $ProjectPath = "FlatOut2.Utils.RichPresence/FlatOut2.Utils.RichPresence.csproj",
    $PackageName = "FlatOut2.Utils.RichPresence",
    ...
    $NuGetPackageId = "FlatOut2.Utils.RichPresence",
